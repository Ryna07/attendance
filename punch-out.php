...
<?php
    ...
    //TO ADD DATA
    if (isset($_POST['add'])) {
      $id = addslashes($_POST['nfc']);

      include 'db_conn.php';

      $query = "INSERT INTO punch_out (nfc) VALUES ('$id')";
      $result = mysqli_query($conn,$query);
      if ($result){
        //echo "<script type='text/javascript'>alert('REGISTER SUCCESS')</script>";
        //header("Location: listparticipant.php");
        $message = "Staff Punch-out!";}
      else
        echo "<script type='text/javascript'>alert('FAILED punch-in')</script>";
    }
    ?>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="dashboard.php" class="btn btn-sm btn-neutral">PUNCH IN</a>
            </div>
          </div>
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        <div class="col">
          ...
          <div class="block">
            <center><h1><strong id="exampleModalLabel" class="h3 text-white mb-0">NFC PUNCH OUT</strong></h1>
            <div class="text-light text-uppercase ls-1 mb-1">
              <p>Scan here to Punch-Out.</p>
              <form action="" method="post" autocomplete="off">
                ...
                <div class="form-group">       
                <center><input type="submit" value="submit" class="btn btn-success js-scroll-trigger" name="add"></center>
                </div>
              </form>
            </div>
            </center>
