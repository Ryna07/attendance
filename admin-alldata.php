      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="admin-alldata.php">
      ...
      <!-- punch in table -->
              <table class="table align-items-center table-flush">
                ...
                <?php
                  ...
                  $records = mysqli_query($conn,"SELECT * from employee, punch_in WHERE employee.nfc = punch_in.nfc"); // fetch data from database
      ...
      <!-- punch in table -->
              <table class="table align-items-center table-flush">
                ...
                <?php
                  ...
                  //$date = date("Y-m-d");
                  include 'db_conn.php'; // Using database connection file here
                  $records = mysqli_query($conn,"SELECT * from employee, punch_out WHERE employee.nfc = punch_out.nfc"); // fetch data from database
